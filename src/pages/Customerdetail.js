...
const columnsCompt = [
    { id: 'srno', label: 'Sr.No', minWidth: 100, align: 'center' },
    { id: 'productName', label: 'Product Name', minWidth: 135, align: 'center' },
    { id: 'productType', label: 'Product Type', minWidth: 135, align: 'center' },
    ...
    { id: 'purchaseDate', label: 'Purchase Date', minWidth: 135, align: 'center' },
    // {
...
export default function Customerdetail() {
    ...
    const[setTableData, setsetTableData] = useState('');
    ...
    const handleSubmit2 = async (e) => {
        ...
        try {
            ...
            if (response.ok) {
                ...
                window.location.reload(handleChange5);
                

            } else {
                setMessage(data.message);
                toast.error('somthing went worng'); // Display the error message in an alert
            }
                                                                        ...
                                                                        <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
                                                                            ...
                                                                            <FormControl
                                                                                sx={{
                                                                                    ...
                                                                                    borderRadius: '5px',
                                                                                    marginTop: '7%',
                                                                                    maxWidth: '100%', // Add this line to limit the maximum width
                                                                                }}
                                                                            >
                                                                                <InputLabel id="Select-Product">Select Product</InputLabel>
                                                                                <Select
                                        ...
                                        <Paper sx={{ width: '100%' }}>
                                            <TableContainer>
                                                ...
                                                <Table stickyHeader aria-label="sticky table" >
                                                    ...
                                                    <TableBody>
                                                        {rowsCompt.length === 0 ? (<TableCell colSpan={columnsCompt.length}>
                                                            <Typography
                                                                variant="p"
                                                                component="div"
